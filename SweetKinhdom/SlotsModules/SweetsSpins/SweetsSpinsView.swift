...
struct SweetsSpinsView: View {
    @StateObject var viewModel =  SweetsSpinsViewModel()
                    ...
                    VStack(spacing: 30) {
                        ...
                        ZStack {
                            Rectangle()
                                ...
                                .frame(width: 330, height: 338)
                                .cornerRadius(20)
                            
                            HStack(spacing: 110) {
                                Rectangle()
                                    .fill(Color(red: 226/255, green: 131/255, blue: 4/255))
                                    .frame(width: 3, height: 338)
