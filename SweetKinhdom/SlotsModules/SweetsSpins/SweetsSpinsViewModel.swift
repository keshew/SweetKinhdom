...
class SweetsSpinsViewModel: ObservableObject {
    let contact = SweetsSpinsModel()
    @Published var coin = UserDefaultsManager.shared.coins
    @Published var bet: Int = 50
    @Published var slots: [[String]] = []
    let allFruits = ["sw1", "sw2", "sw3","sw4", "sw5", "sw6"]
    ...
    let symbolArray = [
        Symbol(image: "sw1", value: "1000"),
        Symbol(image: "sw2", value: "500"),
        Symbol(image: "sw3", value: "100"),
        Symbol(image: "sw4", value: "50"),
        Symbol(image: "sw5", value: "10"),
        Symbol(image: "sw6", value: "5")
    ]
