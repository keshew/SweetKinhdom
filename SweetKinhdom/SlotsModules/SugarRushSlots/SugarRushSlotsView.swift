...
struct SugarRushSlotsView: View {
    @StateObject var viewModel =  SugarRushSlotsViewModel()
                        ...
                        if !isPay {
                            VStack(spacing: -70) {
                                ZStack {
                                    ...
                                    Rectangle()
                                        .fill(LinearGradient(colors: [Color(red: 150/255, green: 31/255, blue: 167/255),
                                                                      Color(red: 121/255, green: 31/255, blue: 207/255)], startPoint: .top, endPoint: .bottom))
                                        .overlay {
                                            RoundedRectangle(cornerRadius: 20)
