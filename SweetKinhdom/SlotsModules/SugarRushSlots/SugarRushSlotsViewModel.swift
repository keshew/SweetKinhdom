...
class SugarRushSlotsViewModel: ObservableObject {
    let contact = SugarRushSlotsModel()
    @Published var coin = UserDefaultsManager.shared.coins
    @Published var bet: Int = 50
    @Published var slots: [[String]] = []
    let allFruits = ["cir1", "cir2", "cir3","cir4", "cir5", "cir6"]
    ...
    let symbolArray = [
        Symbol(image: "cir1", value: "1000"),
        Symbol(image: "cir2", value: "500"),
        Symbol(image: "cir3", value: "100"),
        Symbol(image: "cir4", value: "50"),
        Symbol(image: "cir5", value: "10"),
        Symbol(image: "cir6", value: "5")
    ]
    ...
    private func checkMainDiagonal(minCounts: [String: Int], multipliers: [String: Int], totalWin: inout Int, maxMultiplier: inout Int) {
        let diagonal = [slots[0][0], slots[1][1]]
    ...
    private func checkAntiDiagonal(minCounts: [String: Int], multipliers: [String: Int], totalWin: inout Int, maxMultiplier: inout Int) {
        let diagonal = [slots[0][2], slots[1][1]]
