...
struct CandyFortuneView: View {
    @StateObject var viewModel =  CandyFortuneViewModel()
            ...
            ScrollView(showsIndicators: false) {
                    VStack(spacing: 30) {
                        ...
                        Image("rocket")
                            ...
                            .frame(width: UIScreen.main.bounds.width > 700 ? 500 : 250, height: 400)
                            .rotationEffect(.degrees(viewModel.isFlying ? -5 : 20))
                            .scaleEffect(viewModel.isFlying ? 1.1 : 1.0)
                            .offset(x: viewModel.isFlying ? -50 : -100, y: viewModel.isFlying ? -20 : 40)
